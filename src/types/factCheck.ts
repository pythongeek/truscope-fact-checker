...
export interface Evidence {
  ...
  title: string;
  snippet: string;
  publisher: string; // e.g., "Reuters", "Associated Press"
  publicationDate?: string; // ISO 8601 format: "2025-10-26T00:00:00.000Z"

  // A score from 0-100 based on a predefined list of source reliability.
  // We will populate this using src/data/sourceReliability.ts
  credibilityScore: number;

  // A score from 0-100 for how relevant this evidence is to the specific claim.
  // This will be generated by our new AI analysis step.
...
export interface ClaimVerificationResult {
  ...
  // The "Why": A concise, AI-generated summary of the verdict.
  explanation: string;

  // The "How": The underlying data that led to the verdict.
  reasoning: {
    totalSources: number;
    supportingSources: number;
    conflictingSources: number;
    // A brief summary of the reasoning process.
    conclusion: string;
  };
