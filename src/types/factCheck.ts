...
export interface ScoreMetric {
    name: 'Source Reliability' | 'Corroboration' | 'Directness' | 'Freshness' | 'Contradiction' | 'Cached Confidence' | 'Internal Knowledge' | 'Error Status' | 'Claim Verification' | 'Temporal Accuracy' | 'Recent News Corroboration';
    score: number; // 0-100
    description: string;
}
