...
import { ExternalLink, CheckCircle, Newspaper, Search, Calendar, Building } from 'lucide-react'; // Added Calendar and Building icons
...
                >
                  {/* FIX: Now displays the title of the evidence */}
                  {item.title} <ExternalLink className="inline-block w-4 h-4 ml-1" />
                </a>
                {/* FIX: Displays the publisher (sitename) and date in a single line */}
