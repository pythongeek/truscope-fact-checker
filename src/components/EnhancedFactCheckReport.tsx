...
import { FactCheckReport, ClaimVerificationResult } from '../types';
    ...
    <div className="p-6 bg-gray-50 rounded-lg shadow-md">
      ...
      <div className="mb-6">
        ...
        <p className="text-lg font-bold mt-2">
          ...
          <span className="text-blue-600">{result.overallAuthenticityScore}%</span>
        </p>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {result.claimVerifications.map((claim) => (
