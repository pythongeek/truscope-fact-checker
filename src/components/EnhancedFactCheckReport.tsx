  ...
  return (
    <div className="p-6 bg-gray-50 rounded-lg shadow-md">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700">{tieredFactCheckResult.summary}</p>
        <p className="text-lg font-bold mt-2">
          Overall Authenticity Score:
          <span className="text-blue-600">{tieredFactCheckResult.overallAuthenticityScore}%</span>
        </p>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {tieredFactCheckResult.claimVerifications.map((claim) => (
