...
export const METHOD_CAPABILITIES: Record<FactCheckMethod, MethodCapability> = {
  ...
  'claim-detection': {
    ...
    description: 'Identifies verifiable claims within a text.',
    strengths: ['Can help to focus a fact-checking effort', 'Can be used to automate the process of identifying claims to be fact-checked'],
    limitations: ['May not be able to identify all claims', 'May not be able to distinguish between verifiable and unverifiable claims'],
    processingTime: 'fast',
    accuracyLevel: 'high',
  ...
  'report-generation': {
    ...
    description: 'Generates a report that summarizes the findings of a fact-checking investigation.',
    strengths: ['Can help to communicate the results of a fact-checking investigation to a wider audience', 'Can be used to create a record of a fact-checking investigation'],
    limitations: ['May not be able to capture all of the nuances of a fact-checking investigation', 'May not be able to generate a report that is appropriate for all audiences'],
    processingTime: 'fast',
    accuracyLevel: 'high',
    requiresInternet: false,
    features: {
