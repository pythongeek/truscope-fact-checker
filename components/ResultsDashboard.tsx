...
const getBiasColor = (bias: RichSource['bias_rating']) => {
    switch(bias) {
        case 'Left-Leaning': return 'bg-blue-100 text-blue-800';
        case 'Right-Leaning': return 'bg-red-100 text-red-800';
        case 'Pro-Corporate': return 'bg-indigo-100 text-indigo-800';
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div
                    className="prose prose-blue max-w-none font-serif leading-relaxed enhanced-article-content"
